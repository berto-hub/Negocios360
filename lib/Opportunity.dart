...
class DetailOpporPage extends StatefulWidget{

  Future<Map> opportunity;
  String titleOffer;
  int index;
  List profileData;
  DetailOpporPage(this.index, this.profileData, this.opportunity, this.titleOffer);

  @override
  Opportunity createState() => Opportunity();
}

class Opportunity extends State<DetailOpporPage>{
  ...
  List<String> states = 
    ["Pendiente", "En proceso", "Contratada", "Recompensada", "Archivada", "Ya recompensada", "Cancelada"];
  int i = 0, j = 0;
  String nameButton = "";
  ...
  int getIndex(){
    ...
    setState(() {
      ...
      if(opportunity["state"] == "Ya recompensada"){
        //setState(() {
          index = 3;
        //});
      }
      ...
      children: <Widget>[
        Container(
          ...
          child: TextButton(
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (BuildContext context){
                      return RewardPage(opportunity, widget.profileData);
                    }
                  )
                );
              }

              if(state == "Ya recompensada"){
                setState(() {
                  i = i - 2;
                  j = j - 2;
                  //nameButton = nameButtonState1[i];
            ...
            child: /*nameButtonState1[i + index] == "Desarchivar" ?
            Text("Archivar",
              style: TextStyle(
                color: Colors.white
              ),
            ) :*/
            Text("${nameButtonState1[i + index]}",
              style: TextStyle(
                color: Colors.white
              ),
            ),
