...
class TeamResponsablePage extends StatefulWidget{

  List profileData;
  String idTeam;
  TeamResponsablePage(this.profileData, this.idTeam);

  @override
  TeamResponsable createState() => TeamResponsable();
}

class TeamResponsable extends State<TeamResponsablePage>{
                ...
                children: <Widget>[
                  Card(
                    child: ListTile(
                      ...
                      trailing: widget.profileData[0]["role"] == "responsable" ?
                  ...
                  child: ListTile(
                    ...
                    trailing: widget.profileData[0]["role"] == "responsable" ?
                      ...
                      IconButton(
                        icon: Icon(Icons.more_horiz),
                        onPressed: (){
                          showMyDialog(filterList[index]["id"], filterList[index]["name"], index);
                          //popup(usersData[index]["id"], usersData[index]["name"], index);
                        },
                      ),
