...
class UserSearchPage extends StatefulWidget{
  ...
  List profileData;
  UserSearchPage(this.profileData);

  @override
  UserState createState() => UserState();
}

class UserState extends State<UserSearchPage>{
                    ...
                    onTap: (){
                      filterList[index]["email"] == widget.profileData[0]["email"] ? 
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context){
                              return OtherProfilePage(filterList[index], filterList[index]["id"], widget.profileData);
                            }
                          )
                        );
                      },
